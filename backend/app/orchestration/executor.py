...
class PipelineExecutor:
    ...
    def execute_with_sync_db_tracking(self, db_session, execution):
        ...
        execution.result = {
            ...
            "trade_outcome": serialize_model(state.trade_outcome),
            "final_pnl": state.trade_outcome.pnl if state.trade_outcome else None,
            "final_pnl_percent": state.trade_outcome.pnl_percent if state.trade_outcome else None,
